...
import com.banzhuan.repairservice.shiro.AgileSubjectFactory;
import com.banzhuan.repairservice.shiro.JwtFilter;
import com.banzhuan.repairservice.shiro.JwtPermFilter;
import com.banzhuan.repairservice.shiro.JwtRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager")DefaultWebSecurityManager securityManager){
        ...
        Map<String,String> pathFilter = new LinkedHashMap<>();
        //配置过滤器，连接url
        pathFilter.put("/**","jwt");
        pathFilter.put("/repair", "jwtPerms[/repair]");
